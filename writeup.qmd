...
used to fit a VAR model. This was tested on the clusters created by K-Means Clustering, the groups created by industry
and the groups created by month of IPO.
...
more data is needed to be able to group IPOs by performance.
